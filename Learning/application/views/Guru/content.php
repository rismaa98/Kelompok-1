...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="bi bi-plus-circle btn btn-primary mb-3" data-toggle="modal" data-target="#newSubMenuModal"> Tambah Materi</a>
                ...
                foreach ($content as $hasil) : ?>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td></td> -->
                            <td><?= $hasil->status ?></td>
                            <td><?= date('Y-m-d', $hasil->date_post) ?></td>
                            <td>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url('guru/c_content/') . $user['id'] ?>" method="post">

                <div class="modal-body">
                    <div class="form-group">
                        <select name="id_class" class="form-control">
                            <?php foreach ($show as $hasil) : ?>
                                <option value="<?= $hasil->id_class ?>"><?= $hasil->name_class . ' (' . $hasil->name . ' )' ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
