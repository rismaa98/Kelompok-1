            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                    ...
                    <div class="single_advisor_details_info">
                        <h6><?= $user['name']; ?></h6>
                        <p class="designation">Learning HUB</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-lg-8">
                <div class="text-container">
                    ...
                    <?php foreach ($content as $t) :
                        # code... 
                    ?>
                        <table class="list-unstyled li-space-lg">
                            <tr>
                                <td class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body"><strong>Nama </strong></div></td><td><strong>:</strong></td><td class="media-body"> <?= $user['name'] ?></div>
                                </td>
                            </tr>
                            <tr>
                                 <td class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body"><strong>Tempat, Tanggal Lahir </strong></div></td><td><strong>:</strong></td><td class="media-body"> <?php
                            ...
                            <tr>    
                                <td class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body"><strong>Pendidikan Terakhir </strong></div></td><td><strong>:</strong></td><td class="media-body"> <?php
                            ...
                            <tr>    
                                <td class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body"><strong>Email </strong></div></td><td><strong>: </strong></td><td class="media-body"><?php
                            ...
                            <tr>    
                                <td class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body"><strong>Alamat </strong></div></td><td><strong>:</strong></td><td class="media-body">
                                        <?php if ($t->address) {
                                            echo $t->address;
                                        } else {
                                            echo "Silahkan update data profil";
                    ...
                    <form action="<?= site_url('user/c_edit') ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" name="date_birth" value="<?= $hasil->date_birth ?>" style="background-color: #F6F6F6; color:#062238;">
                            </div>
